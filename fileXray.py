...
class FileProcessor:
    ...
    def analyze_image(self, file_path):
        ...
        if platform.system() != 'Windows':
            try:
                # Use absolute path for safer subprocess call
                exiftool_path = subprocess.check_output(['which', 'exiftool']).decode('utf-8').strip()
            except subprocess.CalledProcessError:
                exiftool_path = 'exiftool' # Fallback if which fails
        else:
            exiftool_path = 'exiftool.exe' # Assumes ExifTool is in PATH

        try:
            # Use -j (JSON output) for structured data
            ...
            # Exclude boilerplate file info tags
            ...
            results['ExifTool Status'] = f"ExifTool not found or subprocess error. Please ensure 'exiftool' is installed and in PATH."
        except Exception as e:
    ...
    def analyze_pdf(self, file_path):
        ...
        if modules_status.get('pdfminer.six'):
            try:
                # This approach needs an intermediate file or string for text/metadata extraction
                # For brevity, we focus on metadata extraction
...
class FileXray:
    ...
    def print_banner(self):
        ...
        # New 3D ASCII Art for FileXray
        ascii_art = [
            f"{Colors.BLUE}{Colors.BOLD}            _/_/_/_/_/_/  _/_/_/_/_/_/ _/_/ _/_/  _/_/_/   _/_/ {Colors.END}",
            f"{Colors.BLUE}           _/           _/           _/ _/ _/  _/    _/ _/   _/ {Colors.END}",
            f"{Colors.BLUE}          _/_/_/_/     _/_/_/_/     _/_/_/   _/_/_/_/ _/_/_/_/  {Colors.END}",
            f"{Colors.BLUE}         _/           _/           _/ _/ _/  _/ _/  _/   _/ _/  {Colors.END}",
            f"{Colors.BLUE}        _/_/         _/_/_/_/_/_/ _/ _/ _/  _/  _/ _/   _/ _/   {Colors.END}"
        ]
        ...
        print(f"{Colors.YELLOW}{Colors.BOLD}           Advanced Multimedia Forensic Analysis Tool{Colors.END}")
        print(f"{Colors.MAGENTA}          Author: Voltsparx | Contact: voltsparx@gmail.com{Colors.END}")
        print(f"{Colors.CYAN}================================================================={Colors.END}")
